"""
CREDIT: https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py
"""
...
def resnet50(pretrained: bool = False, bottleneck: bool = False, classes: int = 10, progress: bool = True, **kwargs: Any) -> ResNet:
