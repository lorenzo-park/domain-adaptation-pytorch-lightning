...
class FashionMNISTM(data.Dataset):
    """`FashionMNIST-M Dataset."""

    url = "https://github.com/lorenzo-park/FashionMNIST-M/releases/download/v1.0/fmnistm_train.pkl"

    def __init__(self, root, mnist_root="data", transform=None, target_transform=None, download=False):
        """Init FMNIST-M dataset."""
        super(FashionMNISTM, self).__init__()
        self.root = os.path.expanduser(root)
        self.mnist_root = os.path.expanduser(mnist_root)
        self.transform = transform
        self.target_transform = target_transform
        self.training_file = 'fmnistm_train.pkl'
    ...
    def download(self):
        """Download the FMNIST-M letters data."""
